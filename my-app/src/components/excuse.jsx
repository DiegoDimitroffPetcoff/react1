...
export function ExcuseGame() {
    ...
    return (
        <div className="mean">
            ...
            <section>
                <div>
                    <h1><button className="button-6" onClick={partyExcuse}>Party</button></h1>
                    <p>{party}</p>
                </div>
                <div><h1><button className="button-6" onClick={familyMeetingExcuse}>Family Meeting</button></h1>
                    <p> {familyMeeting}</p>
                </div>
                <div>
                    <h1><button className="button-6" onClick={officeExcuse}>Office </button></h1>
                    <p>{office}</p>
                </div>
            </section>
